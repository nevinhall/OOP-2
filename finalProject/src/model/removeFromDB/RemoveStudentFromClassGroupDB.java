...
public class RemoveStudentFromClassGroupDB {
    public void removeStudentFromClassGroupFromDB(String studentEmail) {
        try {
        	Connection con = null;
            ...
            String deleteSQL = " Delete from  classGroupStudents where  ClassStudentEmail= '"+studentEmail+"' ";
            //String table = "Docket";
